 ...
 */
final class Version20250515123556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD categorie_id INT NOT NULL, ADD no VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact DROP categorie_id, DROP no');
    }
}
